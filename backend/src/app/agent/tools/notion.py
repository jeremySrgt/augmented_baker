...
async def stock_ingredients(
    ...
    Args:
        query: Filtre optionnel sur le nom de l'ingrédient (ex: "farine").
        limit: Nombre max de lignes (1-100, défaut 25).
    """
...
async def catalogue_produits(
    ...
    Args:
        query: Filtre optionnel sur le nom du produit (ex: "croissant").
        limit: Nombre max de lignes (1-100, défaut 25).
    """
...
async def historique_ventes(
    ...
    Args:
        query: Filtre optionnel sur le nom du produit vendu (ex: "baguette").
        limit: Nombre max de lignes (1-100, défaut 25).
    """
...
async def commandes_fournisseurs(
    ...
    Args:
        query: Filtre optionnel sur le nom du fournisseur ou de la commande.
        limit: Nombre max de lignes (1-100, défaut 25).
    """
