...
Pourquoi pas une autre lib ? Je suis à l'aise sur celle la et ici les abstractions proposées par langchain
ont du sens car elles permettent d'aller vite sans réinventer la roue.
...
Si on était dans un cas de prod, j'aurais ajouté un modèle en fallback, type gpt-5, au cas ou anthropic est indispo ou si
...
Next js est overkill pour ce use cas, j'en ai conscience, mais avec le SDK vercel + leur composant IA déjà tout fait, ça
...
- confirmation l'envoie de mail HITL
- Tool libre idées:
